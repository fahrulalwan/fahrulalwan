...
const SheetOverlay = ({
  ...
  <SheetPrimitive.Backdrop
    className={cn(
      'fixed inset-0 z-overlay bg-overlay transition-opacity duration-300 data-starting-style:opacity-0 data-ending-style:opacity-0',
      className,
    )}
    {...props}
  />
...
const sheetVariants = cva(
  'fixed z-popover gap-4 bg-background p-6 shadow-lg transition ease-in-out data-starting-style:duration-500 data-ending-style:duration-300',
  {
    variants: {
      side: {
